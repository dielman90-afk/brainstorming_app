...
- **Hand-Menü** (`src/wristMenu.js`) auf zwei Reitern à acht Aktionen, damit das
  Panel kompakt bleibt:
  - **💡 Ideen:** *Neue Karte*, *Themen-Start*, *Verwandte Ideen*, *Cluster*,
    *Zusammenfassen*, *Farbe*, *Verbinden*, *Karte löschen*
  - **🗂 Board:** *Rückgängig*, *Wiederholen*, *Whiteboard*, *Umgebung*,
    *Sichern*, *Laden*, *Als Datei*, *Alles löschen* (mit Zweifach-Bestätigung)
...
- **Undo/Redo:** Vollständiger Verlauf über *Anlegen, Löschen, „Alles löschen",
  Verschieben, Größe, Farbe, Text, Cluster, Verbindungen, Import und Laden* –
...
| Umgebung wechseln | Menü → „🌐 Umgebung“ (Passthrough → Himmelsinsel → Nachthimmel → Studio → Konstrukt) |
